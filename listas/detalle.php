...
<?php echo anchor('listas/nick/' .$usuario->nick_mostrar, '<button class="btn btn-default"><i class="fa fa-chevron-left"> </i> Volver</button>');?>
...
<tr><td>
	...
	<?php endforeach;  ?>
	<br/>
	<center><input class='btn btn-success' type='submit' name='btn_ok' id='btn_ok' value='Guardar notas' onclick="this.style.visibility = 'hidden';" />
