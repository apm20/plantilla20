...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'CromosRepes.com', // Site Name
		applicationName: 'CromosRepes.com', // Site Name 
		startURL: 'http://cromosrepes.com', // Homepage URL 
		shortcutIcon: 'http://cromosrepes.com/cr_64.ico', // Main Site Icon
		tooltip: '',
		...
		staticTasks: [{ name: 'Mis Listas',  
action: 'http://www.cromosrepes.com/listas/nick', 
icon: 'http://ie9pinning.blob.core.windows.net/files/JumpList/634633859055063599/Task2-listas.ico', target: 'tab' },
{ name: 'Colecciones',  action: 'http://www.cromosrepes.com/colecciones', 
icon: 'http://ie9pinning.blob.core.windows.net/files/JumpList/634633859055063599/Task1-colecciones_naranja.ico', target: 'tab' },
{ name: 'Mensajes',  action: 'http://www.cromosrepes.com/mensajes/entrada', 
icon: 'http://ie9pinning.blob.core.windows.net/files/JumpList/634633859055063599/Task0-mensajes.ico', target: 'tab' }],
		
		// Drag and drop site pinning bar		
		prompt: true, // Add a site pinning bar on top of my site pages
		barSiteName: 'CromosRepes.com' // Site name as it should appear on the pinning bar
	};
